...
//        substitute(module("com.github.xpenatan.jParser:idl-helper-desktop-jni")).using(project(":idl-helper:idl-helper-desktop-jni"))
//        substitute(module("com.github.xpenatan.jParser:idl-helper-desktop-ffm")).using(project(":idl-helper:idl-helper-desktop-ffm"))
