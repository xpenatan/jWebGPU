...
public class WGPURenderBundleEncoder extends NativeObject {
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "offset", "bytes_addr", "dataSize"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.WGPURenderBundleEncoder);jsObj.setImmediates(offset, bytes_addr, dataSize);")
