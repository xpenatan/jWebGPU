...
public class WGPURenderPassEncoder extends NativeObject {
    ...
    /*[-FFM;-NATIVE]
        extern "C" {
        FFM_EXPORT void jparser_com_github_xpenatan_webgpu_WGPURenderPassEncoder_internal_1native_1SetImmediatesFFM__JIJI(int64_t this_addr, int32_t offset, int64_t data_ptr, int32_t dataSize) {
    ...
    */
    ...
    /*[-TEAVM_C;-NATIVE]
        extern "C" {
        TEAVMC_EXPORT void jwebgpu_teavmc_render_pass_encoder_set_immediates(int64_t this_addr, int32_t offset, int64_t data_ptr, int32_t dataSize) {
            JGPU::WGPURenderPassEncoder* nativeObject = (JGPU::WGPURenderPassEncoder*)this_addr;
            nativeObject->SetImmediates(offset, (void*)data_ptr, dataSize);
        }
        }
    ...
    /*[-FFM;-ADD]
        private static final class FFMImmediateHandles {
            ...
            static final java.lang.invoke.MethodHandle setImmediates = LINKER.downcallHandle(
                    LOOKUP.find("jparser_com_github_xpenatan_webgpu_WGPURenderPassEncoder_internal_1native_1SetImmediatesFFM__JIJI").orElseThrow(),
    ...
    */
    ...
    /*[-TEAVM;-REPLACE]
        @org.teavm.jso.JSBody(params = { "this_addr", "offset", "bytes_addr", "dataSize" }, script = "" +
            "var jsObj = [MODULE].wrapPointer(this_addr, [MODULE].WGPURenderPassEncoder);" +
