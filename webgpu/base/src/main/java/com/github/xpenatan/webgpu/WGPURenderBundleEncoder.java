...
public class WGPURenderBundleEncoder extends NativeObject {
    ...
    /*[-FFM;-NATIVE]
        extern "C" {
        FFM_EXPORT void jparser_com_github_xpenatan_webgpu_WGPURenderBundleEncoder_internal_1native_1SetImmediatesFFM__JIJI(int64_t this_addr, int32_t offset, int64_t data_ptr, int32_t dataSize) {
    ...
    /*[-FFM;-ADD]
        private static final class FFMImmediateHandles {
            ...
            static final java.lang.invoke.MethodHandle setImmediates = LINKER.downcallHandle(
                    LOOKUP.find("jparser_com_github_xpenatan_webgpu_WGPURenderBundleEncoder_internal_1native_1SetImmediatesFFM__JIJI").orElseThrow(),
    ...
    */
    ...
    /*[-TEAVM;-REPLACE]
        @org.teavm.jso.JSBody(params = { "this_addr", "offset", "bytes_addr", "dataSize" }, script = "" +
            "var jsObj = [MODULE].wrapPointer(this_addr, [MODULE].WGPURenderBundleEncoder);" +
