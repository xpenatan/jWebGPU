...
public class WGPUCompilationInfoCallback extends NativeObject {
    ...
    private static final java.util.ArrayList<WGPUCompilationInfoCallback> TEAVMC_CALLBACKS = new java.util.ArrayList<>();
    ...
    @org.teavm.interop.Import(name = "teavmc_WGPUCompilationInfoCallback_setupCallback")
    ...
    @org.teavm.interop.Import(name = "n92349756")
    ...
    @org.teavm.interop.Import(name = "n4013165890")
