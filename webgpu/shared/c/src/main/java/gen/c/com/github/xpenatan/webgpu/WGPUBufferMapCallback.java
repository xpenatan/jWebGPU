...
public class WGPUBufferMapCallback extends NativeObject {
    ...
    private static final java.util.ArrayList<WGPUBufferMapCallback> TEAVMC_CALLBACKS = new java.util.ArrayList<>();
    ...
    private static abstract class TEAVMC_OnCallback_Function extends org.teavm.interop.Function {
        ...
        public abstract void call(int callbackId, int status_addr, org.teavm.interop.Address message_addr);
    }

    @org.teavm.interop.Export(name = "teavmc_WGPUBufferMapCallback_OnCallback")
    private static void teavmc_WGPUBufferMapCallback_OnCallback(int callbackId, int status_addr, org.teavm.interop.Address message_addr) {
        TEAVMC_CALLBACKS.get(callbackId).internal_OnCallback(status_addr, teavmcCStringToString(message_addr));
    }

    @org.teavm.interop.Import(name = "teavmc_WGPUBufferMapCallback_setupCallback")
    ...
    @org.teavm.interop.Import(name = "n141236455")
    ...
    private void setupCallback() {
        ...
        setupCallback(native_address, callbackId, org.teavm.interop.Function.get(TEAVMC_OnCallback_Function.class, WGPUBufferMapCallback.class, "teavmc_WGPUBufferMapCallback_OnCallback"));
    }
    ...
    @org.teavm.interop.Import(name = "n1017461431")
