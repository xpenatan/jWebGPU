...
*/
    ...
    private static final class FFMHandles {
        ...
        static final java.lang.invoke.MethodHandle internal_native_deleteNative__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPU_internal_1native_1deleteNative__J", FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_GetPlatformType__ = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPU_internal_1native_1GetPlatformType__", FunctionDescriptor.of(ValueLayout.JAVA_INT));

        static final java.lang.invoke.MethodHandle internal_native_SetupInstance_addr__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPU_internal_1native_1SetupInstance_1addr__J", FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_SetupInstance_addr__ = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPU_internal_1native_1SetupInstance_1addr__", FunctionDescriptor.of(ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_loadImage_addr__JI = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPU_internal_1native_1loadImage_1addr__JI", FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT));

        static final java.lang.invoke.MethodHandle internal_native_loadImage_addr__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPU_internal_1native_1loadImage_1addr__J", FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG));
    }
}
