...
public class WGPUFloatBuffer extends NativeObject {
    ...
    */
    ...
    private static final class FFMHandles {
        ...
        static final java.lang.invoke.MethodHandle internal_native_deleteNative__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1deleteNative__J", FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_getByteBuffer_addr__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1getByteBuffer_1addr__J", FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_put__0__JF = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1put_1_10__JF", FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG, ValueLayout.JAVA_FLOAT));

        static final java.lang.invoke.MethodHandle internal_native_put__1__JIF = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1put_1_11__JIF", FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.JAVA_FLOAT));

        static final java.lang.invoke.MethodHandle internal_native_get__JI = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1get__JI", FunctionDescriptor.of(ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT));

        static final java.lang.invoke.MethodHandle internal_native_get__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1get__J", FunctionDescriptor.of(ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_remaining__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1remaining__J", FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_getCapacity__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1getCapacity__J", FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_clear__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1clear__J", FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_limit__JI = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1limit__JI", FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT));

        static final java.lang.invoke.MethodHandle internal_native_getLimit__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1getLimit__J", FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_position__JI = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1position__JI", FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT));

        static final java.lang.invoke.MethodHandle internal_native_getPosition__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1getPosition__J", FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG));

        static final java.lang.invoke.MethodHandle internal_native_flip__J = downcallDefault("jparser_com_github_xpenatan_webgpu_WGPUFloatBuffer_internal_1native_1flip__J", FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG));
    }
}
