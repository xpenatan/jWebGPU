...
public class IDLArrayBase extends IDLBase {
    ...
    /*
      [-TEAVM;-NATIVE]
            ...
            jsObj.resize(size);
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "size"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArrayBase); jsObj.resize(size);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArrayBase);
      jWebGPU.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArrayBase);jWebGPU.destroy(jsObj);")
    ...
    /*
      ...
      jsObj.clear();
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArrayBase);jsObj.clear();")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArrayBase);var returnedJSObj = jsObj.getSize();return returnedJSObj;")
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArrayBase);var returnedJSObj = jsObj.getPointer();return returnedJSObj;")
