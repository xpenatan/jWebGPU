...
public class IDLStringView extends IDLBase {
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLStringView); var returnedJSObj = jsObj.data(); return returnedJSObj;")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new jWebGPU.IDLStringView(text);
      return jWebGPU.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"text"}, script = "var jsObj = new jWebGPU.IDLStringView(text);return jWebGPU.getPointer(jsObj);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new jWebGPU.IDLStringView(text, size);
      return jWebGPU.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"text", "size"}, script = "var jsObj = new jWebGPU.IDLStringView(text, size);return jWebGPU.getPointer(jsObj);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLStringView);
      jWebGPU.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLStringView);jWebGPU.destroy(jsObj);")
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLStringView);var returnedJSObj = jsObj.size();return returnedJSObj;")
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLStringView);var returnedJSObj = jsObj.at(index);return returnedJSObj;")
