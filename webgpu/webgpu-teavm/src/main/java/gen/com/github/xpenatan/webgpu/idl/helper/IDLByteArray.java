...
public class IDLByteArray extends IDLArrayBase {
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new jWebGPU.IDLByteArray(size);
      return jWebGPU.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"size"}, script = "var jsObj = new jWebGPU.IDLByteArray(size);return jWebGPU.getPointer(jsObj);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLByteArray);
      jWebGPU.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLByteArray);jWebGPU.destroy(jsObj);")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLByteArray);var returnedJSObj = jsObj.getValue(index);return returnedJSObj;")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index", "value"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLByteArray);jsObj.setValue(index, value);")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "src_addr", "srcOffset", "destOffset", "length"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLByteArray);jsObj.copy(src_addr, srcOffset, destOffset, length);")
