...
public class IDLArray extends IDLBase {
    ...
    /*
      [-TEAVM;-NATIVE]
            ...
            jsObj.resize(size);
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "size"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArray); jsObj.resize(size);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArray);
      jsObj.clear();
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArray);jsObj.clear();")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArray);var returnedJSObj = jsObj.getSize();return returnedJSObj;")
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArray);var returnedJSObj = jsObj.ownsDataAddress();return returnedJSObj;")
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLArray);var returnedJSObj = jsObj.getVoidData();return returnedJSObj;")
