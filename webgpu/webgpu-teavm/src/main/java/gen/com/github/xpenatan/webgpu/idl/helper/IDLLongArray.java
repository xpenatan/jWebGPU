...
public class IDLLongArray extends IDLArrayBase {
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new jWebGPU.IDLLongArray(size);
      return jWebGPU.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"size"}, script = "var jsObj = new jWebGPU.IDLLongArray(size);return jWebGPU.getPointer(jsObj);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLLongArray);
      jWebGPU.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLLongArray);jWebGPU.destroy(jsObj);")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLLongArray);var returnedJSObj = jsObj.getValue(index);return returnedJSObj;")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index", "value"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLLongArray);jsObj.setValue(index, value);")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "src_addr", "srcOffset", "destOffset", "length"}, script = "var jsObj = jWebGPU.wrapPointer(this_addr, jWebGPU.IDLLongArray);jsObj.copy(src_addr, srcOffset, destOffset, length);")
